...
// import cake from "../components/images/cake.jpg";
// import cake2 from "../components/images/cake2.jpg";

// const imgDb = { cake, cake2 };
...
export const server = () => {
  return new Server({
    ...
    routes() {
      ...
      this.get("/recipes/:title", (schema, request) => {
      ...
      this.get("/recipe.id/:id", (schema, request) => {
        ...
        // this.get("/recipes", (schema, request) => schema.recipes.all());
